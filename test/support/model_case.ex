defmodule ItemsApi.ModelCase do
  @moduledoc """
  ...
  setup tags do
    ...
    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(ItemsApi.Repo, {:shared, self()})
    end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ItemsApi.ErrorHelpers.translate_error/1)
